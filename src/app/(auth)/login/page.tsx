...
const Page: FC = ({}) => {
  ...
  return (
    <>
      <div className="flex w-full min-h-screen items-center justify-center md:justify-between p-10 md:p-0">
        <div className="hidden md:flex w-[50%] h-screen bg-indigo-600 flex-1  justify-center items-center">
          <svg
        ...
        <div className="md:w-[50%] w-full flex flex-col items-center m-auto">
          <Logo />
          <div className="flex flex-col items-center gap-8 md:px-20">
            <h2 className="my-5 text-center text-sm tracking-tight text-gray-900">
              StreamTalk brings you closer to your conversations in real-time.
              Enter your credentials below to dive into seamless communication.
            </h2>
          </div>
